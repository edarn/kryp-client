...
TNA_QuerySQL("INSERT INTO `test_data` SET time='$dag $klocka',averageDir=$ad,maxDir=$maxd,minDir=$mind,averageSpeed=$as,maxSpeed=$maxs,minSpeed=$mins,version='$version', battery='$batt'");
